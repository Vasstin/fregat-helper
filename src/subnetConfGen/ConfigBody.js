...
const Config = (props) => {
  ...
  return (
    <div className="">
      <p>
        set interfaces {props.configData.Port} unit {props.configData.Vlan} description {props.configData.VlanName}-{props.configData.Vlan}
      </p>
      <p>
        set interfaces {props.configData.Port} unit {props.configData.Vlan} vlan-id {props.configData.Vlan}
      </p>
      <p>
        set interfaces {props.configData.Port} unit {props.configData.Vlan} family inet mtu 1500
      </p>
      <p>
        set interfaces {props.configData.Port} unit {props.configData.Vlan} family inet address {props.configData.Gateway}/{props.configData.Mask}
      </p>
      <p>---------------------------------------</p>
      {props.nextHost === "Olt" ? (
        <Box>
          ...
          <p>service-port {props.configData.serviceNumber} vport 1 user-vlan {props.configData.Vlan} transparent </p>
          <p>exit</p>
          <p>pon-onu-mng {props.configData.onuPort}</p>
          <p>service {props.configData.Vlan} gemport 1 vlan {props.configData.Vlan}</p>
          <p>exit</p>
          <p>exit</p>
          <p>wr</p>
        </Box>
